...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=Path, default=Path.home() / "datasets" / "pubmed_research")
    parser.add_argument("--queries", action="append", default=["crispr therapy", "rna vaccines", "emdr therapy"])
    args = parser.parse_args()

    output_dir = Path(args.output_dir)
    create_dataset(output_dir, args.queries)
